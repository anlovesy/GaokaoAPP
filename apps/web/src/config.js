...
export const advisorModeOptions = [
  {
    ...
    shortLabel: "直说模式",
    badge: "老师模式",
    tone: "像一位懂高考规则、敢说真话的老师，先给判断，再讲理由。",
    opening:
      "我先说明一句：下面这个模式，是基于公开表达风格整理出来的老师式顾问，不是本人原声复刻。但你放心，我会按真实填报逻辑，直接和你把利弊讲透。"
  },
  {
    value: "gentle",
    label: "耐心陪聊模式",
    shortLabel: "陪聊模式",
    badge: "陪伴模式",
    tone: "更温和一些，适合边聊边梳理，不会一上来就给太强压迫感。",
    opening:
...
export const defaultFormState = {
  ...
  careerPlan:
    "希望进入人工智能、数据分析、互联网产品或高端制造方向，兼顾就业质量和大城市发展机会",
  notes:
    "主要服务广东考生，希望优先考虑广东和大湾区院校，也接受省外强校",
  maxTuition: 12000,
  englishScore: 128,
