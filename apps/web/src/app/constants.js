...
export const ENTRY_MODE_STORAGE_KEY = "gaokao_entry_mode";
export const ADVISOR_STATE_STORAGE_KEY = "gaokao_advisor_state";
export const WORKSPACE_RESULT_STORAGE_KEY = "gaokao_workspace_result";

export const SCREEN_LANDING = "landing";
export const SCREEN_AUTH = "auth";
export const SCREEN_NAVIGATION = "navigation";
...
export const SCREEN_ACCOUNT = "account";
export const SCREEN_ADMIN_USERS = "admin-users";
...
export const RISK_OPTIONS = [
  ...
  { value: "conservative", label: "保守型", description: "优先稳定录取" }
];
